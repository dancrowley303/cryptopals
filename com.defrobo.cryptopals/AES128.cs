...
namespace com.defrobo.cryptopals
{
    ...
    {
        public static byte[] gmul2 = new byte[256]
        {
        ...
        public static byte[] gmul3 = new byte[256]
        {
        ...
        public static byte[] gmul9 = new byte[256]
        {
        ...
        public static byte[] gmul11 = new byte[256]
        {
        ...
        public static byte[] gmul13 = new byte[256]
        {
        ...
        public static byte[] gmul14 = new byte[256]
        {
        ...
        {
            var a = new byte[4];
            Buffer.BlockCopy(column, 0, a, 0, 4);
            column[0] = (byte)(gmul2[a[0]] ^ a[3] ^ a[2] ^ gmul3[a[1]]);
            column[1] = (byte)(gmul2[a[1]] ^ a[0] ^ a[3] ^ gmul3[a[2]]);
            column[2] = (byte)(gmul2[a[2]] ^ a[1] ^ a[0] ^ gmul3[a[3]]);
            column[3] = (byte)(gmul2[a[3]] ^ a[2] ^ a[1] ^ gmul3[a[0]]);
        }
        ...
        private static void InvGmixColumn(byte[] column)
        {
            var a = new byte[4];
            Buffer.BlockCopy(column, 0, a, 0, 4);
            column[0] = (byte)(gmul14[a[0]] ^ gmul9[a[3]] ^ gmul13[a[2]] ^ gmul11[a[1]]);
            column[1] = (byte)(gmul14[a[1]] ^ gmul9[a[0]] ^ gmul13[a[3]] ^ gmul11[a[2]]);
            column[2] = (byte)(gmul14[a[2]] ^ gmul9[a[1]] ^ gmul13[a[0]] ^ gmul11[a[3]]);
            column[3] = (byte)(gmul14[a[3]] ^ gmul9[a[2]] ^ gmul13[a[1]] ^ gmul11[a[0]]);
        }

        //This is of historical value only now as I'm using lookup tables as they are faster
        //if this were prod code I'd delete it
        public static byte Gmul(byte a, int bAsInt)
        {
            var p = default(byte);
            var b = (byte)bAsInt;
            var hiBitSet = 0x00;
